...
public class ItemSpriteSheet {
	...
	public static final int HEAVY_CLEAVER   = WEP_TIER4+7;
	static{
		...
		assignItemRect(HEAVY_CLEAVER,   16, 16);
	}
	...
	public static final int OBSIDIAN_BLADE  = WEP_TIER5+7;
	static{
		...
		assignItemRect(OBSIDIAN_BLADE, 16, 16);
	}
